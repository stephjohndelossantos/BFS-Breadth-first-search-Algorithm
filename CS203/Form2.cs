...
namespace CS203
{
    public partial class USC : Form
    {
        ...
        private void btnadjacentnodes_Click(object sender, EventArgs e)
        {
            try
            {
                if (stopcreate == true)
                {
                    ...
                    //calculate distance-
                    int x = (int)(xcoordinate2 - xcoordinate1);
                    int y = (int)(ycoordinate2 - ycoordinate1);
                    ...
                    graph.DrawString((d).ToString(), new Font("Arial", 10), Brushes.Maroon, a, b);
                ...
                try
                {
                    ...
                    while (sr.Peek() != -1)
                    {
                        ...
                        for (int i = 1; i < adjacent.Length; i++)
                        {
                            ...
                            int b = ((int)(y1 + y2) / 2) - 5;
                            //graph.DrawString((d).ToString(), new Font("Arial", 10), Brushes.Maroon, a, b);
                            g.DrawString((d).ToString(), new Font("Arial", 12),
                                Brushes.Maroon, a, b);
        ...
        public void ucsTraversal()
        {
            ...
            try
            {
                PriorityClass pq = new PriorityClass();
                ...
                while (pq.Count != 0)
                {
                    ...
                    {
                        if (diagram[current.Item1, i] != 0)
                        {
                            if (!visited.Contains(new Tuple<int, int>(i, default)))
                            {
                                int tempDistance = current.Item2 + diagram[current.Item1, i];
        ...
        {
            label5.Text = "The Traversal Path is : ";
            ucsTraversal();
        }

        private void USC_Load(object sender, EventArgs e)
        {
